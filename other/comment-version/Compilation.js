	...
	*/
    ...
    class Compilation extends Tapable {
        ...
        constructor(compiler) {
            ...
            // @dm entry配置的入口chunk的渲染模版
            this.mainTemplate = new MainTemplate(this.outputOptions);
            // @dm 动态引入的非入口chunk的渲染模板
         ...
         */
        // @dm 创建完module之后 继续构建，loader在这一步起作用
        buildModule(module, optional, origin, dependencies, thisCallback) {
            // @dm 收集模块构建之后的回调函数 放入Map
            let callbackList = this._buildingModules.get(module);
            if (callbackList) {
        ...
        seal(callback) {
            ...
            for (const preparedEntrypoint of this._preparedEntrypoints) {
                ...
                // @dm 将chunk与chunkgroup和module取得联系
                ...
                this.hooks.additionalAssets.callAsync(err => {
                    ...
                    this.hooks.optimizeChunkAssets.callAsync(this.chunks, err => {
                        ...
                        this.hooks.optimizeAssets.callAsync(this.assets, err => {
                            ...
                            // @dm 代码split时 当hash不匹配时 视为无效的代码块 则舍弃
        ...
        createChunkAssets() {
            ...
            for (let i = 0; i < this.chunks.length; i++) {
                ...
                try {
                    /**
                     * @dm MainTemplate渲染的代码中含有启动webpack的代码，而非入口chunk是不需要的
                    */
                    const template = chunk.hasRuntime()
                        ? this.mainTemplate
                        : this.chunkTemplate;
